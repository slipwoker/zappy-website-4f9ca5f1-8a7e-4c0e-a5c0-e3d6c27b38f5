document.addEventListener('DOMContentLoaded', function() {
    ...
    if (navbar) {
        ...
        window.addEventListener('scroll', function() {
            ...
            scrollTimeout = requestAnimationFrame(updateNavbarClass);
        }, { passive: true });
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.closest && (input.closest('[name="name"]') || 
                input.closest('[name="email"]') || 
                input.closest('[name="phone"]') || 
                input.closest('[name="message"]'))) {
                clearError(input);
            }
        });
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4f9ca5f1-8a7e-4c0e-a5c0-e3d6c27b38f5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4f9ca5f1-8a7e-4c0e-a5c0-e3d6c27b38f5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4f9ca5f1-8a7e-4c0e-a5c0-e3d6c27b38f5';
